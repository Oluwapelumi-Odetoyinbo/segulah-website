  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="p-3 bg-mlm-green-500 text-white rounded-full shadow-lg hover:bg-mlm-green-600 transition-all duration-300 animate-bounce"
          aria-label="Scroll to top"
        >
          <Icon icon="solar:arrow-up-bold" className="w-6 h-6" />
        </button>
      )}
    </div>
  );
